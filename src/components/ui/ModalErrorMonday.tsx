 ...
 *
 * Antes cada pantalla resolvía esto a su manera —un cartel rojo dentro de la lista, un texto bajo
 * un botón, un renglón en el lugar de la ficha—, así que el mismo problema se veía distinto en
 * cada paso y en varios casos quedaba tapado por el contenido. Un fallo de la API no es un estado
 * de la pantalla: es algo que interrumpe la operación y hay que decirlo de frente.
 */
