...
export function VentaProformaView() {
  ...
  /* Sin `conActividades`: la comisión ya no se muestra en esta pantalla (se mudó al resumen de la
     última etapa), así que no hace falta resolver la cadena para pintarla. */
