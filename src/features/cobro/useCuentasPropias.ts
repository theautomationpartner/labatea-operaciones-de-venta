...
/**
 * Cuentas bancarias propias de La Batea, del tablero de cuentas. Se consultan UNA sola vez, recién
 * cuando el medio de cobro que las necesita entra en pantalla (`activo`): la transferencia, para la
 * cuenta de destino, y la tarjeta, para el banco de acreditación. El ref evita re-consultar al
 * volver a entrar; `estado` NO puede ir en las deps del efecto (su set lo re-ejecutaría y
 * cancelaría la consulta recién lanzada).
 */
