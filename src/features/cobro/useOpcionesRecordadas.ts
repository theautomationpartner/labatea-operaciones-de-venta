...
/**
 * Tipos de tarjeta fijos. Son los dos que el board tiene cargados en "🤖Tipo Tarjeta"
 * (dropdown_mm5rx800); los que agregue el usuario se crean como etiqueta al escribir el
 * subelemento, porque la mutación va con `create_labels_if_missing`.
 */
