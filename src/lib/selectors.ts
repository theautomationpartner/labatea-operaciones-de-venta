...
/* ══════════════════════════════════════════════════════════════════════════════════════════════
   ...
   Importes y porcentajes van con dos decimales REDONDEADOS (`round2`), el mismo criterio que
   ROUND(x, 2) de las fórmulas del maestro: el precio de la planilla llega 125.834,69 y rinde
   22,9999995%, que se muestra 23,00%.
...
/* ── Rentabilidad forzada ────────────────────────────────────────────────────────────────────
   ...
   Ejemplo: Costo 102.162,35 · Flete 175 · Precio (pisado por el administrador) 110.000 · 23%
     Nuevo Costo     = (110.000 − 175) / 1,23             = 89.288,62  (89.288,617… redondeado)
