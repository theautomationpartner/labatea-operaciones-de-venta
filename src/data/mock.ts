...
export const VENDEDORES: Vendedor[] = [
  { ini: 'LT', name: 'Luciano Torres', color: 'var(--avatar-orange)' },
  { ini: 'MS', name: 'María Silva', color: 'var(--red)' },
  { ini: 'JG', name: 'Javier Gómez', color: 'var(--green)' },
  { ini: 'PR', name: 'Paula Ríos', color: '#575ce5' },
  { ini: 'DC', name: 'Diego Cabrera', color: 'var(--primary-blue)' },
]
